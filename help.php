	  			...
	  			<div class="conatainer-fluid col-sm-2"></div>
	  				<div class="container-fluid col-sm-8"> 
	      				...
	      				<div class="panel panel-default" style="padding: 0;background-color:#f5edeb;">
	      					...
	      					<h3>Answer to some questions that will help you to operate:</h3>
	      					<img src="image/question.jpg"  width="100%" height="100%">
	      					<h3>You can make a official id for this website to take advantage of <a href="index.php">kinmail.com </a> </h3>
	      					...
	      					<img src="image/h3.png"  width="100%" height="100%"> <br>	<br>	
